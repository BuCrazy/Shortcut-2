...
//    @Binding var topWords: [WordItemStruct]
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ScrollView(.horizontal, showsIndicators: false) {
                HStack {
                    ForEach(topWords, id: \.id) { slovo in
                        WordChip(
                            chipWord: slovo.word,
                            onRemove: {
                                withAnimation {
                                    self.topWords.removeAll { $0 == slovo }
                                }
                            },
        ...
        case .down:
            withAnimation {
                ...
                switch currentLevelSelected {
                    case "elementary":
                            storedNewWordItemsDataLayer.elementaryKnewAlready.removeAll { item in
                                item.position_now == newItem.position_now
                            }
                            storedNewWordItemsDataLayer.elementaryBeingLearned.append(wordItemNew(
                                id: newItem.id,
                    ...
                    case "beginner":
                            storedNewWordItemsDataLayer.beginnerKnewAlready.removeAll { item in
                                item.position_now == newItem.position_now
                            }
                            storedNewWordItemsDataLayer.beginnerBeingLearned.append(wordItemNew(
                                id: newItem.id,
                                position_now: newItem.position_now,
                                word: newItem.word,
                                dateAdded: storedStatesDataLayer.currentDate,
                    ...
                    case "intermediate":
                            storedNewWordItemsDataLayer.intermediateKnewAlready.removeAll { item in
                                item.position_now == newItem.position_now
                            }
                            storedNewWordItemsDataLayer.intermediateBeingLearned.append(wordItemNew(
                                id: newItem.id,
                                position_now: newItem.position_now,
                                word: newItem.word,
                                dateAdded: storedStatesDataLayer.currentDate,
                    ...
                    case "advanced":
                            storedNewWordItemsDataLayer.advancedKnewAlready.removeAll { item in
                                item.position_now == newItem.position_now
                            }
                            storedNewWordItemsDataLayer.advancedBeingLearned.append(wordItemNew(
                                id: newItem.id,
                                position_now: newItem.position_now,
                                word: newItem.word,
                                dateAdded: storedStatesDataLayer.currentDate,
                    ...
                    case "nativelike":
                            storedNewWordItemsDataLayer.nativelikeKnewAlready.removeAll { item in
                                item.position_now == newItem.position_now
                            }
                            storedNewWordItemsDataLayer.nativelikeBeingLearned.append(wordItemNew(
                                id: newItem.id,
                                position_now: newItem.position_now,
                                word: newItem.word,
                                dateAdded: storedStatesDataLayer.currentDate,
                    ...
                    case "borninengland":
                            storedNewWordItemsDataLayer.borninenglandKnewAlready.removeAll { item in
                                item.position_now == newItem.position_now
                            }
                            storedNewWordItemsDataLayer.borninenglandBeingLearned.append(wordItemNew(
                                id: newItem.id,
                                position_now: newItem.position_now,
                                word: newItem.word,
                                dateAdded: storedStatesDataLayer.currentDate,
...
struct KnowSection_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return KnowSection(topWords: .constant([newWordItem]), bottomWords: .constant([newWordItem]), selectedWordItem: .constant(newWordItem))
...
//        return KnowSection(topWords: .constant([wordItem]), selectedWordItem: .constant(wordItem))
    }
}
