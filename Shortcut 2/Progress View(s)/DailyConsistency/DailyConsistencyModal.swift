...
struct DailyConsistencyModal: View {
    @Binding var activeModal: ActiveModal
    var title: String = "Daily Concistency"
    var description: String = "Displays the your consistency in discovering words through out the week"
    var body: some View {
        Spacer()
        VStack {
            HStack {
...
#Preview {
    DailyConsistencyModal(activeModal: .constant(.none))
}
