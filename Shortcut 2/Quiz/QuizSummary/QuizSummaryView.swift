                ...
                ScrollView {
                    VStack {
                        ...
                        VStack(spacing: 24) {
                            ...
                            HistoricalDataView(quizHistory: storedNewWordItems.shared.quizHistory)
                                .padding(.horizontal, 16)
...
struct QuizSummary_Previews: PreviewProvider {
    ...
    static var previews: some View {
        QuizSummaryView(
            correctAnswerNumber: .constant(correctAnswerNumber),
            incorrectAnswerNumber: .constant(incorrectAnswerNumber),
            isQuizAlreadyStarted: .constant(false))
    }
}
